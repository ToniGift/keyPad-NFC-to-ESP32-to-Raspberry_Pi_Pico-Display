...
const char* mqtt_topic_nfc = "esp32/data";
const char* mqtt_topic_keypad = "esp32/keypad";
...
void readNFC() {
    ...
    if (nfc.readPassiveTargetID(PN532_MIFARE_ISO14443A, uid, &uidLength)) {
        ...
        if (client.connected()) {
            ...
            client.publish(mqtt_topic_nfc, tagData.c_str());
...
void sendKeypadData() {
    if (client.connected()) {
        Serial.println("Sending keypad data to MQTT...");
        client.publish(mqtt_topic_keypad, keypadInput.c_str());
        Serial.println("Keypad Data Sent: " + keypadInput);
    } else {
        Serial.println("MQTT Disconnected! Reconnecting...");
        reconnectMQTT();
    }
